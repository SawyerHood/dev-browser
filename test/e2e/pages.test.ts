/**
 * End-to-end: named pages, anonymous pages, listPages/closePage, `dev-browser pages`.
 */
...
beforeAll(async () => {
  cli = makeCliEnv("dev-browser-e2e-pages-");
...
describe("named pages", () => {
  ...
  test("pages file under DEV_BROWSER_HOME/pages/*.json contains the name -> targetId", async () => {
