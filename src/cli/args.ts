 ...
 *
 *   dev-browser [flags] < script.js
 *   dev-browser [flags] -e 'code'
 *   dev-browser [flags] run FILE
 *   dev-browser pages | browsers | status | stop [NAME] | install | install-skill [...] | migrate-from-doobie | chrome [...] | help [topic] | daemon
 */
        ...
        if (!command) {
          switch (a) {
            ...
            case "migrate-from-doobie":
              command = { kind: "migrate-from-doobie" };
              break;
            case "chrome":
            ...
            case "mcp":
              ...
              break;
            default:
              throw new UsageError(`unknown command "${a}". Run dev-browser --help.`);
          }
        } else {
