 ...
 * file asset and stores its path in globalThis.__DEV_BROWSER_DAEMON_ASSET.
...
declare global {
  ...
  var __DEV_BROWSER_DAEMON_ASSET: string | undefined;
}

export async function loadDaemonModule(): Promise<DaemonModule> {
  const asset = globalThis.__DEV_BROWSER_DAEMON_ASSET;
