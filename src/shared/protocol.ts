/**
 * Wire protocol between the doobie client and the daemon.
 *
 ...
 *
 * The same frames are what `doobie --json` prints, so an MCP server or bb
...
/** Launch a Chrome with a persistent named profile under ~/.doobie/browsers/<name>. */
