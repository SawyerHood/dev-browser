...
export function smallHtml(): string {
  ...
  return `<!doctype html>
<html lang="en">
<head><meta charset="utf-8"><title>dev-browser bench: small</title>
...
<body>
<header><h1>dev-browser</h1><nav aria-label="Main"><ul>${navItems}</ul></nav></header>
<main>
  ...
  <section id="about"><h2>About</h2>
    <p>dev-browser is a browser automation CLI for coding agents. Scripts are plain Puppeteer; a warm daemon keeps Chrome
...
<footer><p>&copy; 2026 dev-browser &middot; <a href="/terms">Terms</a> &middot; <a href="/privacy">Privacy</a></p>
